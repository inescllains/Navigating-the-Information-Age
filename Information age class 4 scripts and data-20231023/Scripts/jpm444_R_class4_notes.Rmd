...
These are to get the directories. 
```{r}
...
```{r}
d<-read_tsv("C:/Users/Ines/OneDrive - FSV/CU1/Navigating the Information Age/Navigating-the-Information-Age/Information age class 4 scripts and data-20231023/Data/ngecEvents.20231002133358.Release642.DV.txt")
```
...
#Replace this for the homework with google for the homework. 
```
...
```{r}
#name of the output file
outputname<-"C:/Users/Ines/OneDrive - FSV/CU1/Navigating the Information Age/Information age class 4 scripts and data-20231023/Data/rssfeed_AJ.txt"
#print out the output
